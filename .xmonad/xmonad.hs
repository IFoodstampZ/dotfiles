...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        ...
        , ("M-d", spawn "dm-run") -- Dmenu

    -- KB_GROUP Other Dmenu Prompts
    -- In Xmonad and many tiling window managers, M-p is the default keybinding to
    -- launch dbindsym $mod+q killmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
    ...
    -- KB_GROUP Kill windows
        ...
        , ("M-x", kill1)   -- Kill all windows on current workspace
    ...
    -- KB_GROUP Emacs (SUPER-e followed by a key)
        , ("M-c", spawn (myEmacs ++ ("--eval '(dashboard-refresh-buffer)'")))   -- emacs dashboard
